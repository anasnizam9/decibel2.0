...
const successionEssentialFeatures = [
  {
    ...
    description:
      "The endeavor to enhance an employeeâ€™s current or future performance by cultivating their capabilities through structured learning.",
    icon: "ðŸŽ¯",
  },
  {
    title: "Systematic Training Program Development",
    description:
      "The systematic design framework tailored to fulfill specific requirements through the formulation of precise objectives, well-defined steps, and comprehensive training content.",
    icon: "ðŸ“‹",
  },
          ...
          <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
            <div className="text-white">
              <h1 className="text-4xl font-bold md:text-5xl">
                Learning, Planning and Administration
              </h1>
              <p className="mt-5 max-w-[620px] text-base leading-relaxed md:text-lg">
                With our learning planning and administration service, you can optimize employee development. In addition to creating, delivering, and tracking training programs, we offer a centralized platform and focus on enhancing skills in the best possible way.
              </p>
              <Link
                href="#"
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
            ...
            <div className="flex items-center justify-center">
              <img
                ...
                alt="Learning Feature Interface"
