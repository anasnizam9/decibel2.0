...
const successionEssentialFeatures = [
  {
    title: "Comprehensive Attendance Management Solutions",
    description:
      "Our suite of tools provides a comprehensive solution for managing employee attendance.",
    icon: "🎯",
  },
  {
    title: "Productivity Optimization",
    description:
      "These tools empower your organization to optimize productivity.",
    icon: "📋",
  },
  {
    title: "Efficient Workforce Management",
    description:
      "They streamline the management of your workforce.",
    icon: "📈",
  },
  {
    title: "Consistent Attendance Tracking",
    description:
      "These tools ensure consistent and accurate tracking of employee attendance.",
    icon: "📈",
  },
          ...
          <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
            <div className="text-white">
              ...
              <p className="mt-5 max-w-[620px] text-base leading-relaxed md:text-lg">
                With the Payroll & Attendance Software, we are offering you simplified workforce tracking with precision and ease. We automate attendance records, monitor punctuality, and generate insightful reports using BEST ATTENDANCE SOFTWARE ON CLOUD. Enhancing efficiency, reducing errors, and cultivating an accountable culture are some of the major benefits of this service.
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
            ...
            <div className="flex items-center justify-center">
              <img
                src="/images/att.png"
                alt="Attendance Feature Interface"
