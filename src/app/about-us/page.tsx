...
export default function AboutUsPage() {
  return (
    <main>
      ...
      {/* ── SECTION 2: About Company & Our Mission — exact split screen ── */}
      <section className="flex min-h-[520px] flex-col md:flex-row">

        {/* LEFT: Blue panel — exactly 50% */}
        <div className="relative flex w-full flex-col justify-center overflow-hidden bg-[#1a65a8] px-10 py-16 text-white md:w-1/2">

          {/* Large outer circle — centered right, partially off screen */}
          <div
          ...
          />
          {/* Medium circle inside, same center */}
          <div
            className="pointer-events-none absolute"
            style={{
              width: 230,
          ...
          />
          {/* Small circle — bottom left, partially off */}
          <div
            className="pointer-events-none absolute"
            style={{
              width: 160,
          ...
          <h2 className="relative z-10 mb-6 text-4xl font-extrabold leading-tight">
            About Company
          </h2>
          <p className="relative z-10 max-w-md text-[15px] leading-8 text-white/85">
            We are a trusted provider of innovative type of Services, customized to
            delivering unparalleled solutions and customer support to businesses of all
            sizes. With years of experience and a dedication to quality, we help
            businesses streamline their operations and achieve their goals.
          </p>
        </div>

        {/* RIGHT: White panel — exactly 50% */}
        <div className="flex w-full flex-col justify-center bg-white px-12 py-16 md:w-1/2">
          <h2 className="mb-10 text-4xl font-extrabold text-[#122f2b]">
            Our Mission
          </h2>
          ...
          <div className="space-y-0">
            ...
            <div className="flex items-start gap-5 pb-8">
              <div
                className="flex shrink-0 items-center justify-center rounded-lg bg-[#deeef8]"
              ...
              <div>
                <h3 className="mb-2 text-[17px] font-extrabold text-[#122f2b]">
                  Our Company Mission
                </h3>
                <p className="text-[15px] leading-7 text-[#5a7068]">
                  Our mission is to be a trusted partner for our clients. Vision to be the leading
                  provider of types of Services and 15 years of professional services offered in
                  the industry.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5 pt-8">
              ...
              <div>
                ...
                <p className="text-[15px] leading-7 text-[#5a7068]">
                  Deliver exceptional quality and performance in all our products and services.
                  Provide personalized solutions that are tailored to each client&apos;s unique
                  requirements.
                </p>
              </div>
            </div>
      ...
      {/* ── SECTION 3: Pakistan's Leading HR Platform ── */}
      <section className="bg-[#f7fbf9] py-12 md:py-16">
        <div className="mx-auto max-w-6xl px-6">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#73a292]">About Decibel</p>
          <h2 className="mt-2 text-3xl font-extrabold leading-tight text-[#122f2b] md:text-5xl">
