...
const successionEssentialFeatures = [
  {
    title: "Fast Compensation Processing",
    description:
      "From expertly managing payroll taxes to enabling you to effortlessly perform tasks at your fingertips, we simplify intricate processes, allowing you to reclaim valuable time and embody a sense of mastery. Decibel’s payroll services are designed to streamline your operations, offering you time-saving convenience through these features.",
    icon: "🎯",
  },
  {
  ...
  },
  {
    ...
    description:
      "Easier tax deduction calculation with no chance of errors.",
    icon: "📈",
  },
  {
    title: "Legal Compliance",
    description:
      "Simple integration with time-tracking and HR “Minimize the risks associated with legislative matters, employment-related taxes, and compliance concerns.",
    icon: "📈",
  },
  {
    title: "Benefits Management",
    description:
      "Reduce time, energy and headcount associated with administering benefits programs.",
    icon: "📈",
  },
   {
    title: "Workforce Engagement",
    description:
      "Lower the cost of educating your workforce about their benefits which improves employee satisfaction.",
    icon: "📈",
  },
];
          ...
          <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
            <div className="text-white">
              ...
              <p className="mt-5 max-w-[620px] text-base leading-relaxed md:text-lg">
                We offer a hassle-free Top Payroll Platform and payroll services for managing the entire team’s compensation. From payroll processing to catering to the detailed benefits of administration, we ensure 100% employee satisfaction. You will get advanced Payroll and Attendance Software and BPO payroll services.
