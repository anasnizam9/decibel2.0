        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          ...
          <div className="relative flex justify-center items-center w-full">
            ...
            <motion.img
              ...
              src={active.desktopImg}
              alt="Desktop"
              className="rounded-lg shadow-2xl border-2 border-white/20 object-cover w-full"
              style={{ maxWidth: '520px', maxHeight: '370px' }}
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
            ...
            <motion.img
              ...
              src={active.mobileImg}
              alt="Mobile"
              className="absolute rounded-lg shadow-2xl border-2 border-white/20 object-cover bg-white"
              style={{
                width: '130px',
                bottom: '-16px',
                right: '-10px',
